...
class SolutionVariants {
    ...
    static class FrequencyMapSolver implements Solver {
        @Override
    ...
    static class ParitySetSolver implements Solver {
        @Override
        public int longestPalindrome(String s) {
    ...
    //More Efficient
    static class FixedSizeFrequencyArraySolver implements Solver {
        @Override
        public int longestPalindrome(String s) {
